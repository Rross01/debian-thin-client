...
- **RAM:** Максимальное потребление, которого удалось достичь - 1022 Мб, но с учётом непрерывной работы устройства может потребоваться больший объём.
...
# Установка в Legacy режиме, на примере GigaByte GB-BACE-3000.
### Проблема:
В ходе эксплуатации тонких клиентов модели GigaByte GB-BACE-3000 у большинства села батарейка, из-за чего при каждой потере питания настройки BIOS сбрасываются на дефолтные, и в приоритет загрузки встаёт первый диск.
### Решение:
Установить ОС в Legacy режиме, чтобы загрузка происходила с MBR раздела самого диска, а не с UEFI приложения. Для этого необходимо:  
...
# Чек-лист тестирования Тонкого клиента
Наименование | Статус | Комментарий
-------------|--------|------------
Работает проброс USB-гарнитур (управление громкостью, чувствительностью микрофона, mute) | ок | ок
Работает проброс аналоговых гарнитур (управление громкостью, чувствительностью микрофона) | |
Поддержка аудиоконференций через Skype for Bussiness | |
Поддержка видеоконференций через Skype for Bussiness | |
Поддержка видеоконференций Zoom | |
Поддержка 2-х мониторов без потери общей производительности | |
Адаптивная подстройка под разрешение монитора/мониторов | |
Работает бесшовное переключение раскладок клавиатуры RUS/ENG, все символы пропечатываются корректно | |
Поддерживается доменная авторизация на Тонком клиенте | |
Поддержка комбинаций клавиш Windows "горячие клавиши" Win+L, Win+D, Ctrl+Alt+Delete | |
Возможность сделать снимок экрана на Тонком клиенте и отправить в техническую поддержку | |
В виртуальном рабочем месте одновременно работает проброс звука в обе стороны (обязательно RealTime) и веб-приложения, при этом отсутствуют прерывания при разговоре Клиента со специалистом Контакт-центра. | |
Комфортный просмотр видеороликов в виртуальной среде (плавное воспроизведение, синхронизированы видео и звук, без потери общей производительности) | |